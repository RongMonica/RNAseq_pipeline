...
java -jar ~/GitHub_Rong/RNAseq_pipline/tools/Trimmomatic-0.39/trimmomatic-0.39.jar PE \
    -threads 4 \
    data/SRR390728_1.fastq data/SRR390728_2.fastq \
    data/SRR390728_1_trimmed.fastq data/SRR390728_1_unpaired.fastq \
    data/SRR390728_2_trimmed.fastq data/SRR390728_2_unpaired.fastq \
    ILLUMINACLIP:tools/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:30:10 \
    TRAILING:10 \
    -phred33
echo "Trimmomatic finished running!"

fastqc data/SRR390728_1_trimmed.fastq \
    data/SRR390728_2_trimmed.fastq \
...
hisat2 -q -x HISAT2/grch38/genome \
    -1 data/SRR390728_1.fastq \
    -2 data/SRR390728_2.fastq \
    | samtools sort - -o HISAT2/SRR390728_trimmed.bam
...
featureCounts -p --countReadPairs -s 0 \
    -a HISAT2/Homo_sapiens.GRCh38.106.gtf \
    -o quants/SRR390728_featureCounts.txt \
    HISAT2/SRR390728_trimmed.bam
